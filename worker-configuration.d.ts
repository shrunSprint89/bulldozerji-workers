/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e95379b54033c35bfebdbfd6895f1d18)
// Runtime types generated with workerd@1.20250508.0 2025-05-20 
declare namespace Cloudflare {
	interface Env {
		INDIANAPI_API_KEY: string;
		MAX_SYMBOLS_TO_FETCH: string;
		SYMBOL_PROCESSOR: DurableObjectNamespace<import("./src/index").SymbolProcessor>;
		SymbolsDB: D1Database;
		ASSETS: Fetcher;
	}
}
