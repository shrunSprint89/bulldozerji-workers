-- Migration number: 0003 	 2025-05-27T12:34:29.506Z
-- Migration number: 0002 	 2025-05-27T12:27:24.154Z
...
CREATE TABLE IF NOT EXISTS peer_companies (
    ...
    ylow REAL,
    yhigh REAL,
    PRIMARY KEY (company_id, ticker_id),
...
CREATE TABLE IF NOT EXISTS financial_data (
    ...
    yqoq_comp TEXT,
    qoq_comp TEXT,
    PRIMARY KEY (company_id, financial_type, financial_key, fiscal_year, end_date),
    FOREIGN KEY (company_id) REFERENCES companies(company_id)
);
...
CREATE TABLE IF NOT EXISTS key_metrics (
    ...
    value TEXT,
    PRIMARY KEY (company_id, metric_category, metric_key),
    FOREIGN KEY (company_id) REFERENCES companies(company_id)
);
